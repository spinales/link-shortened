    ...
    return (
        <footer className="p-4 md:p-8 lg:p-10 bg-gray-800">
            <div className="mx-auto max-w-screen-xl text-center">
                ...
                <p className="my-6 text-gray-500 dark:text-gray-400">Open-source library of over 400+ web components
                    and interactive elements built for better web.</p>
                ...
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023-2023
                    <a href="/"
                        className="hover:underline"> BitCutter™ </a>. All Rights Reserved.</span>
            </div>
        </footer>
    );
}