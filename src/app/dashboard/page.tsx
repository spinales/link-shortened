...
const DashboardPage = () => {
    ...
    return (
        <div className="bg-gray-100">
            <div className="flex items-center justify-between py-2 mx-auto bg-palette-bg shadow-xl pr-4">
            ...
            <div className="w-full mx-auto my-10 rounded-md max-w-7xl bg-neutral-100 h-[80vh]">
                <p className="text-palette-primary text-2xl font-semibold">Links</p>
                <form onSubmit={handleSubmit} className="mt-2">
                    <Label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link a agregar</Label>
