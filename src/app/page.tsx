                ...
                <div
                    ...
                    <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                        ...
                        <p className="mb-4">We are strategists, designers and developers. Innovators and problem
                            ...
                            pace
                            you need. Small enough to be simple and quick, but big enough to deliver the scope you want
                            at
                            the pace you need.</p>
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen-md mb-8 lg:mb-16">
                        ...
                        <p className="text-gray-500 sm:text-xl dark:text-gray-400">Here at BitCutter we focus on markets
                    ...
                    <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                        <div
                            ...
                            <div className="p-5">
                                ...
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Bonnie drives the
                        ...
                        <div
                            ...
                            <div className="p-5">
                                ...
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Jese drives the
                                    technical strategy of the flowbite platform and brand.</p>
                                <ul className="flex space-x-4 sm:mt-0">
                                    <li>
                                        <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <div
                            ...
                            <div className="p-5">
                                ...
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Michael drives the
                                    technical strategy of the flowbite platform and brand.</p>
                                <ul className="flex space-x-4 sm:mt-0">
                                    <li>
                                        <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <div
                            ...
                            <div className="p-5">
                                ...
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Lana drives the
                                    technical strategy of the flowbite platform and brand.</p>
                                <ul className="flex space-x-4 sm:mt-0">
                                    <li>
                                        <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
